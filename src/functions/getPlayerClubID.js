...
module.exports = {
  ...
  code: async (d) => {
    ...
    try {
      ...
      const playerClubTag = playerData.club ? playerData.club.tag : "No club found";

      data.result = playerClubTag;

      return {
        code: d.util.setCode(data)
      };
    } catch (error) {
      return d.aoiError.fnError(d, "custom", {}, "Failed to retrieve player club ID. Please check the ID and token.");
    }
  },
};
