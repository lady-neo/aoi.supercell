  ...
  code: async (d) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        return d.aoiError.fnError(d, "custom", {}, "Failed to retrieve player experience points. Please check the ID and token.");
      }

      const playerData = await response.json();
      const playerExpPoints = playerData.expPoints;

      data.result = playerExpPoints;
